...
function customFilterModel({ timeData, typeData }) {
            ...
            <View style={styles.modelCustomFilterView}>
                ...
                <View style={{ justifyContent: 'space-between', width: '100%', flexDirection: 'row' }}>
                    <View style={{ width: '50%', alignItems: 'center' }}>
                        <ListViewSingleSelect data={timeData} />
                    </View>
                    <View style={{ width: '50%', alignItems: 'center' }}>
                        <ListViewSingleSelect data={typeData} />
                    </View>
                </View>
                <TouchableOpacity style={{ position: 'absolute', width: '100%', height: '100%', justifyContent:'flex-end', alignItems:'flex-end'}}>
