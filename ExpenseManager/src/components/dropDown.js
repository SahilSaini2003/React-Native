...
function dropDown({ data, state, setState, textData, setTextData, handelFilterDropdown}) {


    return (
        <>
            <TouchableOpacity style={{ height: 40, flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }} onPress={() => { setState(!state); handelFilterDropdown(data) }}>
